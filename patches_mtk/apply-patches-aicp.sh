...
echo ""
cd system/core
git apply -v ../../device/wileyfox/porridge/patches_mtk/system_core_aicp.patch
cd ../..
echo ""
...
echo ""
cd system/sepolicy
git apply -v ../../device/wileyfox/porridge/patches_mtk/system_sepolicy_rr.patch
cd ../..
echo ""
...
echo ""
cd frameworks/av
git apply -v ../../device/wileyfox/porridge/patches_mtk/frameworks_av_new_aicp.patch
cd ..
echo ""
